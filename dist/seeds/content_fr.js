...
exports.seedContentFr = seedContentFr;
...
async function seedContentFr() {
    ...
    console.log(`[seed] content_fr: upserted ${entries.length} keys for language="${LANGUAGE}" ` +
...
//# sourceMappingURL=content_fr.js.map