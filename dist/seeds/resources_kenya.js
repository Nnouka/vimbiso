...
exports.seedResourcesKenya = seedResourcesKenya;
...
exports.RESOURCES = [
    ...
    },
    {
        ...
        source_name: 'STAND-IN: Huduma Kenya contact centre — NOT a confirmed dedicated State Department for Gender line. ' +
...
async function seedResourcesKenya() {
    ...
    for (const r of exports.RESOURCES) {
        ...
        const { rows: existing } = await pool.query('SELECT id FROM resources WHERE country = $1 AND category = $2 AND name = $3', [r.country, r.category, r.name]);
        if (existing.length > 0) {
            await pool.query(`UPDATE resources SET
         ...
         WHERE id = $9`, [
            ...
            await pool.query(`INSERT INTO resources
    ...
    console.log(`[seed] resources_kenya: upserted ${exports.RESOURCES.length} KE resources. ` +
...
//# sourceMappingURL=resources_kenya.js.map