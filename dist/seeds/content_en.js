...
exports.seedContentEn = seedContentEn;
...
exports.CONTENT = {
    ...
    'guidance.device_safety': "A few ways to keep this chat more private on this phone:\n\n" +
    ...
    'stub.coming_soon': 'This is coming very soon — for now, please see the national GBV hotline: HAK 1195 (toll-free).',
    // ===========================================================================
    ...
    'rights.disclaimer': 'This is example information and has not yet been reviewed by a legal partner.',
    ...
    'pw.consent_prompt': 'Would you like to name who did this, only to check if others have reported the same person? This never changes what happens with your case.',
...
async function seedContentEn() {
    ...
    const entries = Object.entries(exports.CONTENT);
    for (const [key, text] of entries) {
        await pool.query(`INSERT INTO content_strings (key, language, text, tier)
       VALUES ($1, $2, $3, $4)
       ON CONFLICT (key, language) DO UPDATE SET
         text = EXCLUDED.text,
         tier = EXCLUDED.tier`, [key, LANGUAGE, text, TIER]);
    }
...
//# sourceMappingURL=content_en.js.map