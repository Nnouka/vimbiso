...
test_1.test.describe('Dashboard login (DASH-1)', () => {
    (0, test_1.test)('wrong credentials show an error and do not redirect', async ({ page }) => {
    ...
    (0, test_1.test)('correct credentials redirect to the reports queue', async ({ page }) => {
        await page.goto('/login');
    ...
    (0, test_1.test)('an unauthenticated request to /dashboard redirects to /login', async ({ page }) => {
...
//# sourceMappingURL=dashboard-login.spec.js.map