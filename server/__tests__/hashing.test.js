/**
 * Tests for normalizeAndHash(text) — server/lib/hashing.js (SEC-1)
 *
 ...
 * Backend implements server/lib/hashing.js. That failure is correct and expected
...
// test value before requiring the module, so hashing.js reads a real secret
...
const { normalizeAndHash } = require('../lib/hashing');
