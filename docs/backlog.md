...
Still open: the actual live echo-within-5-seconds round-trip and a confirmed real language-selection tap, now that both crashes are fixed — re-test needed.
Dependencies: none.
